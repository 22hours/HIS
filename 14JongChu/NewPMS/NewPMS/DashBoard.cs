...
namespace NewPMS
{
    public partial class DashBoard : Form
    {
        ...
        {
            string TopCaption = "jongchu's PMS";
        ...
        private void DashBoardDataGrid_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {

        }

        private void SystemStatusGroupBox_Enter(object sender, EventArgs e)
        {
